...
<body class="bg-gradient-success h-100 d-flex flex-column justify-content-center align-items-center">
  <div class="container">
    <!-- Outer Row -->
              ...
              <div class="col">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">Usted está accediendo como: <span class="badge badge-secondary">Jefe de cocheras</span></p>
                  </div>
                  <form class="user">
    ...
    <a href="http://localhost:8080/Cocheras/loginEmpleado" class="text-white position-absolute mb-3 mr-4" style="bottom: 0; right:0;"><i class="fas fa-user"></i> - Acceder como empleado</a>
  </div>
