    ...
    <div class="col-lg-11" style="max-width: 600px">
      ...
      <div id="toPrint" style="display: none">
        <div style="border: 3px solid; padding: 20px; display: inline-block; font-family: monospace">
          <p style="font-size:25px">Fecha: <b><%=diario.getFechaIngreso()%></b></p>
          <p style="font-size:25px">Patente: <b><%=diario.getVehiculo().getPatente()%></b></p>
          <p style="font-size:25px">Lugar: <b><%=diario.getLugar().getNroLugar()%></b></p>
          <p style="font-size:25px">Cochera: <b><%=diario.getLugar().getCochera().getNombre()%></b></p>
          <hr>
          <p style="font-size:25px"><b><%=diario.getComprobante()%></b></p>
          ...
          <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-0">
             <label class="mb-0 ml-1" for="id">Id de Ingreso</label>
              <input class="form-control form-control-user" type="text" name="id" value="<%=diario.getComprobante()%>">
            </div>
          </div>
          <div class="form-group row">
            <div class="col-sm-5">
