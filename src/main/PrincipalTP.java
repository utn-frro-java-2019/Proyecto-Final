	...
	public static void main(String[] args) {
		...
		for (Empleado e : empleados) {
			System.out.println("Empleado: " + e.getDni() + " - " + e.getNombre() + " - " + e.getApellido() + " - "
					+ e.getCochera().getIdCochera() + " - " + e.getTurno().getDescripcion());
		}
		...
		for (Turno t : turnos) {
			System.out.println(
					"Turno: " + t.getIdTurno() + " - " + t.getDescripcion() + " - " + t.getHoraInicio() + " - " + t.getHoraFin());
		}
		ArrayList<Estadia> estadias = EstadiaController.getAll();
		for (Estadia es : estadias) {
			System.out.println("Estadia: " + es.getCochera().getIdCochera() + " - " + es.getVehiculo().getPatente() + " - "
					+ es.getLugar().getNroLugar() + " - " + es.getFechaIngreso() + " - " + es.getEstado());
		}
		...
		for (TipoVehiculo tv : tiposVehiculos) {
			System.out.println(
					"TipoVehiculo: " + tv.getIdTipo() + " - " + tv.getDescripcion() + " - " + tv.getPorcentajeMultiplicador());
		}
		...
		for (MultiplicadorEstadia me : multiplicadoresEstadias) {
			System.out
					.println("MultiplicadorEstadia: " + me.getMultiplicadorDesde() + " - " + me.getPorcentajeMultiplicador());
		}
